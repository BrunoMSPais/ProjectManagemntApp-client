      ...
      <div className='flex items-center gap-8'>
        <div className='relative flex w-[200px]'>
          ...
          <input
            type='search'
            placeholder='Search...'
            className='bg-gary-100 p-2 pl-8 placeholder-gray-500 focus:border-transparent focus:outline-none dark:bg-gray-700 dark:text-white dark:placeholder-white'
          />
        </div>
      </div>
      {/* Icons */}
